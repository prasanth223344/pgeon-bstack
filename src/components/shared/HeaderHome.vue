 ...
 <router-link :to="{ path: '/notifications' }" class="header-bell pointer mr20p fc "  v-bind:class="{ 'header-bell--with-notif': notif_count }" >
      ...
      <div class="mobile-dropdown m-auto mw6">
           ...
           <router-link :to="{ path: '/'  }" class="pointer" v-bind:class="{ active: $route.path == '/' }">
          <span>Published Responses</span>
        ...
        <router-link class="pointer" v-bind:class="{ active: $route.path == '/questions' }" :to="{ path: '/questions'  }">
          <span>Open Questions</span>
          
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" v-if="$route.path == '/questions'">
            <path
              d="M435.848 83.466L172.804 346.51l-96.652-96.652c-4.686-4.686-12.284-4.686-16.971 0l-28.284 28.284c-4.686 4.686-4.686 12.284 0 16.971l133.421 133.421c4.686 4.686 12.284 4.686 16.971 0l299.813-299.813c4.686-4.686 4.686-12.284 0-16.971l-28.284-28.284c-4.686-4.686-12.284-4.686-16.97 0z"
            ></path>
          </svg>
