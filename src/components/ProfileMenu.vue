      ...
      <div class="mw6 m-auto">
        ...
        <div class="profile-preview mt15p">
          ...
          <div class="profile-url">
            <p class="m0 flex">
              <span class="flex1 profile-url_input">www.pgeon.com/u/{{current_user.username}}</span>
              <!-- <input class="user-slug-input" value disabled> -->
            </p>

   <span v-clipboard:copy="'www.pgeon.com/u/'+current_user.username"  v-clipboard:success="copied">
                <div class="copy-icon">
                 <img class="v-mid" src="../assets/img/svg/copy.svg">
